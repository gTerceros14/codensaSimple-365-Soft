...
class CifrasEnLetrasController extends Controller
{
    //---------------------------------------------
  // CONSTANTES
  ...
  //Unidades del  al 29
  public static $listaUnidades = array(
  ...
  //Decenas
  public static $listaDecenas = array(
    "", "diez", "veinte", "treinta", "cuarenta", "cincuenta", "sesenta", "setenta", "ochenta", "noventa"
  );

  //Centenas
  public static $listaCentenas = array (
    "", "cien", "doscientos", "trescientos", "cuatrocientos", "quinientos", "seiscientos", "setecientos", "ochocientos", "novecientos"
  );

  //Millones en Singular
  public static $listaOrdenesMillonSingular = array (
  ...
  //Millones en plural
  public static $listaOrdenesMillonPlural = array (
  ...
  public static function convertirBolivianosEnLetras($bolivianos, $numeroDecimales=2) {
    return self::convertirNumeroEnLetras($bolivianos, $numeroDecimales);
  }
