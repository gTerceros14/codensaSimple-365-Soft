                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <button type="button" @click="listarVenta(1, buscar, criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr v-for="venta in arrayVenta" :key="venta.id">
                                        <td>
                                            ...
                                            <button type="button" @click="irACobros()" class="btn btn-primary btn-sm">
                                                <i class="icon-arrow-right"></i> Ingresar Cobro
                                            </button>
                                        </td>
                ...
                <div class="card-header">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select id="opcion1" class="form-control">
...
<script>
    ...
    export default {
        ...
        methods: {
            irACobros() {
                this.activeTab = 1; // Cambiar a la pestaña "Cobros".
            },
            ...
            console.log('CRITERIO',me.criterio)
            console.log('BUSCAR',me.buscar)
