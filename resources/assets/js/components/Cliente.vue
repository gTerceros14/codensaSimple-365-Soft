        ...
        <div class="form-group d-md-flex justify-content-md-between">
          <div class="col-md-6">
            <div class="input-group">
              ...
              <input type="text" v-model="buscar" @keyup="listarPersona(1, buscar, criterio)" class="form-control"
          ...
          <div v-if="rolUsuario == 1" class="col-md-3">
            ...
            <v-select id="selectUsuarioFiltro" :on-search="selectUsuarioFiltro" label="nombre"
              :options="arrayUsuarioFiltro" placeholder="Buscar Usuario..." :onChange="getDatosUsuarioFiltro"
      ...
      <div class="modal-dialog modal-primary modal-lg" role="document">
        <div class="modal-content">
                ...
                <div class="col-md-6">
                  ...
                  <div>
                    <select class="form-control" v-model="datosFormulario.tipo_documento"
                      :class="{ 'is-invalid': errores.tipo_documento }" @change="validarCampo('tipo_documento')">
          ...
          "" }}
                  ...
                  <input type="text" v-model="datosFormulario.num_documento" class="form-control" id="num_documento"
                    placeholder="Ej. 12345678" :class="{ 'is-invalid': errores.num_documento }"
              ...
              <div class="form-group row" v-if="activaredit == true && rolUsuario == 1">
                <label for="user" class="font-weight-bold">Usuario <span class="text-danger">*</span></label>
                <div class="col-md-9">
                  <v-select :on-search="selectUsuario" label="nombre" :options="arrayUsuarioV"
                    placeholder="Buscar Usuario..." :onChange="getDatosUsuario" v-model="usuarioSeleccionado">
                  </v-select>
                </div>
              </div>
            </div>
