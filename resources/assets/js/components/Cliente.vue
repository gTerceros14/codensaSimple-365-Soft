        ...
        <div class="card-body">
          <div class="form-group d-md-flex justify-content-md-between">
            ...
            <div v-if="rolUsuario == 1" class="col-md-3">
              <label for="selectUsuarioFiltro" class="form-label"
                ><strong>Buscar Cliente por Usuario</strong></label
              >
              <v-select
                id="selectUsuarioFiltro"
                ...
                <tr v-for="persona in arrayPersona" :key="persona.id">
                  ...
                  <td>
                    ...
                    >
                      ...
                      <span class="text-black">{{ persona.direccion }}</span>
                    </a>
                  </td>
                  <td>
                    <a
            ...
            <div class="modal-body">
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  />
                  <p class="text-danger" v-if="errores.nombre">
                    {{ errores.nombre }}
                  </p>
                </div>
                <div class="col-md-6">
                  ...
                  />
                  <p class="text-danger" v-if="errores.direccion">
                    {{ errores.direccion }}
                  </p>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    >
                      <option value="" disabled
                        >Selecciona una tipo de documento</option
                      >
                      <option value="1">CI - CEDULA DE IDENTIDAD</option>
                      <option value="2"
                        >CEX - CEDULA DE IDENTIDAD DE EXTRANJERO</option
                      >
                      <option value="5"
                        >NIT - NÚMERO DE IDENTIFICACIÓN TRIBUTARIA</option
                      >
                      <option value="3">PAS - PASAPORTE</option>
                      <option value="4"
                        >OD - OTRO DOCUMENTO DE IDENTIDAD</option
                      >
                    </select>
                  </div>
                  <p class="text-danger" v-if="errores.tipo_documento">
                    {{ errores.tipo_documento }}
                  </p>
                </div>
                <div class="col-md-3">
                  <label for="num_documento" class="font-weight-bold"
                    >N°
                    {{
                  ...
                  />
                  <p class="text-danger" v-if="errores.num_documento">
                    {{ errores.num_documento }}
                  </p>
                </div>
                <div class="col-md-3">
                  <label class="font-weight-bold" for="complemento"
                    >Complemento</label
                  >
                  <input
                  ...
                  <input
                    type="text"
                    v-show="mostrarComplemento"
                    v-model="datosFormulario.complemento"
                    class="form-control"
                    id="complemento"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  />
                  <p class="text-danger" v-if="errores.email">
                    {{ errores.email }}
                  </p>
                </div>
              </div>
              <div
                ...
                role="alert"
              >
                Este cliente fue creado por:
                <strong>{{ usuarioSeleccionado }}</strong
                >.
              </div>
              <div
                class="form-group row"
                v-if="activaredit == true && rolUsuario == 1"
              >
