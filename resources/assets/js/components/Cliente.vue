                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    ...
                                    <td>
                                        <a :href="'https://www.google.com/maps/search/?api=1&query=' + persona.direccion"
                                    ...
                                    <td>
                                        <a :href="'tel:' + persona.telefono" target="_blank"
                                    ...
                                    <td>
                                        <a :href="'mailto:' + persona.email" target="_blank"
                                            class="d-flex align-items-center text-decoration-none">
                    ...
                    <form @submit.prevent="enviarFormulario">
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <label for="direccion" class="font-weight-bold">Dirección del cliente <span
                                            class="text-danger">*</span></label>
                                    <input type="text" v-model="datosFormulario.direccion" class="form-control"
                                        id="direccion" placeholder="Ej. Calle Principal #123, Ciudad"
                                        :class="{ 'is-invalid': errores.direccion }" @input="validarCampo('direccion')">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="telefono" class="font-weight-bold">Teléfono <span
                                            class="text-danger">*</span></label>
                                    <input type="text" v-model="datosFormulario.telefono" class="form-control"
                                        id="telefono" placeholder="Ej. 7XXXXXX"
                                ...
                                <div class="col-md-6">
                                    <label for="email" class="font-weight-bold">Correo electrónico <span
                                            class="text-danger">*</span></label>
                                    <input type="text" v-model="datosFormulario.email" class="form-control" id="email"
                                        placeholder="Ej. ejemplo@dominio.com" :class="{ 'is-invalid': errores.email }"
                                        @input="validarCampo('email')">
                                    <p class="text-danger" v-if="errores.email">{{ errores.email }}
                                    </p>
                                </div>
                            </div>
