<template>
  <main class="main">
                  ...
                  <tr v-for="venta in arrayVenta" :key="venta.id">
                    ...
                    <td>
                      <button
                        ...
                        type="button"
                        @click="imprimirFactura(venta.id, venta.correo)"
                      >
    ...
    <template v-if="listado == 0">
      <registrarventa @cerrar="ocultarDetalle"> </registrarventa
    ></template>
  </main>
</template>
      ...
      swal({
        ...
        .then((result) => {
          if (result.value) {
            ...
            axios
              .get("/factura/imprimirCarta/" + id + "/" + correo, {
                responseType: "blob",
              })
              .then(function(response) {
            ...
            axios
              .get("/factura/imprimirRollo/" + id + "/" + correo, {
                responseType: "blob",
              })
              .then(function(response) {
