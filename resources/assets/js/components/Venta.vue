  ...
  <main class="main">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a class="text-decoration-none" href="/">Escritorio</a>
      </li>
    </ol>
    <div class="container-fluid">
      <!-- Ejemplo de tabla Listado -->
      <div class="card">
        <div class="card-header">
          ...
          >
          <span class="badge bg-secondary" id="cuis">CUIS: Inexistente</span>
          <span class="badge bg-secondary" id="cufd"
            >No existe cufd vigente</span
          >
          <span
            class="badge bg-secondary"
            id="direccion"
            v-show="mostrarDireccion"
            >No hay dirección registrada</span
          >
          <span class="badge bg-primary" id="cufdValor" v-show="mostrarCUFD"
            >No hay CUFD</span
          >
        </div>
        <!-- Listado-->
                ...
                <tbody>
                  <tr v-for="venta in arrayVenta" :key="venta.id">
                    <td class="d-flex align-items-center">
                      ...
                      <template
                        v-if="
                          venta.idtipo_venta == 2 && venta.estado == 'Pendiente'
                        "
                      >
                        <button
                          type="button"
                    ...
                    <td>
                      <a
                        @click="
                          verificarFactura(venta.cuf, venta.numeroFactura)
                        "
                        target="_blank"
                        class="btn btn-info"
                        ><i class="icon-note"></i
                    ...
                    <td>
                      <button
                        ...
                        type="button"
                        @click="imprimirFactura(venta.id, venta.email)"
                      >
                      ...
                      <button
                        ...
                        type="button"
                        @click="anularFactura(venta.id, venta.cuf)"
                      >
          ...
          <div class="card-body">
            <div class="form-group row border">
              ...
              <input
                ...
                id="complemento_id"
                class="form-control"
                v-model="complemento_id"
                ref="complementoIdRef"
                readonly
              />
              <input
                type="hidden"
              ...
              <div class="col-md-3">
                ...
                <div class="form-check">
                  <input
                    ...
                    type="checkbox"
                    v-model="casosEspeciales"
                    id="casosEspecialesCheckbox"
                    @change="habilitarNombreCliente"
                  />
              ...
              <div
                v-if="clienteDeudas > 0"
                class="alert alert-danger text-center "
                role="alert"
                style="width: 100%;"
              >
                Este cliente tiene <b>{{ clienteDeudas }}</b> pagos pendientes
                de crédito.
            ...
            <div class="form-group row border">
              <div class="col-md-3">
                <label for="" class="font-weight-bold">Buscar articulo </label>
                <div class="input-group mb-3">
                  <input
                    ...
                    aria-label="Codigo del articulo"
              ...
              <template v-if="arraySeleccionado && arraySeleccionado.id">
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <span class="badge bg-primary"
                      >Medida: {{ arraySeleccionado.medida }}</span
                    >
                    <span class="badge bg-primary"
                      >Linea: {{ arraySeleccionado.nombre_categoria }}</span
                    >
                    <p>
                      {{ arraySeleccionado.descripcion }}
                    </p>
                    <p>
                      <b>Cantidad por empaque: </b
                      >{{ arraySeleccionado.unidad_envase }}
                    </p>

                    <h3
                      v-if="arrayPromocion && arrayPromocion.id"
                    ...
                    >
                      ...
                      <s style="font-size:15px" class="lead"
                        >{{
                          (
                            resultadoMultiplicacion * parseFloat(monedaVenta[0])
                          ).toFixed(2)
                        }}
                        {{ monedaVenta[1] }}</s
                      >
                    ...
                    <p
                      ...
                      class="text-danger"
                    >
                      <i class="fa fa-clock-o" aria-hidden="true"></i> Esta
                      oferta termina en
                      {{
                        calcularDiasRestantes(arrayPromocion.fecha_final)
                      }}
                      días
                    </p>
                  </div>
                ...
                <div class="col-md-3 d-flex flex-column align-items-center">
                  <img
                    v-if="
                      arraySeleccionado.length > 0 &&
                        arraySeleccionado.fotografia
                    "
                    :src="
                      'img/articulo/' +
                        arraySeleccionado.fotografia +
                  ...
                  <div
                    :class="{
                      alert: true,
                      'alert-success':
                        arraySeleccionado.saldo_stock / unidadPaquete -
                          cantidad >
                        arraySeleccionado.stock / unidadPaquete,
                      'alert-warning':
                        arraySeleccionado.saldo_stock / unidadPaquete -
                          cantidad <=
                        arraySeleccionado.stock / unidadPaquete,
                  ...
                  >
                    ...
                    <b
                      >{{
                        arraySeleccionado.saldo_stock / unidadPaquete - cantidad
                      }}
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    >
                      <option :value="arraySeleccionado.unidad_envase"
                        >Por paquete</option
                      >
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    >
                      ...
                      <option
                        :value="arraySeleccionado.precio_uno"
                        v-if="arrayPrecios[0]"
                        >{{ arrayPrecios[0].nombre_precio }}</option
                      >
                      <option
                        :value="arraySeleccionado.precio_dos"
                        v-if="arrayPrecios[1]"
                        >{{ arrayPrecios[1].nombre_precio }}
                      </option>
                      <option
                        :value="arraySeleccionado.precio_tres"
                        v-if="arrayPrecios[2]"
                      >
                        {{ arrayPrecios[2].nombre_precio }}</option
                      >
                      <option
                        :value="arraySeleccionado.precio_cuatro"
                        v-if="arrayPrecios[3]"
                      >
                  ...
                  <tbody v-if="arrayDetalle.length">
                    ...
                    >
                      <td>
                        ...
                        <button
                          v-else
                          @click="eliminarKit(detalle.idkit)"
                          type="button"
                          class="btn btn-danger btn-sm"
                        >
                          <i class="icon-close"></i>
                      ...
                      <td>
                        {{
                          (detalle.cantidad / detalle.unidad_envase).toFixed(2)
                        }}
                      </td>
                    ...
                    <tr style="background-color: #CEECF5;">
                      ...
                      <td id="montoTotal">
                        {{
                          (calcularTotal * parseFloat(monedaVenta[0])).toFixed(
                            2
                          )
                        }}
                        {{ monedaVenta[1] }}
            ...
            <div class="d-flex justify-content-between">
              <div class="col-md-4">
                <label class="col-form-label" for="tipoVenta"
                  ><strong>Tipo de Venta</strong></label
                >
                ...
                <table class="table table-bordered table-striped table-sm">
                  ...
                  <tbody v-if="arrayDetalle.length">
                    <tr v-for="detalle in arrayDetalle" :key="detalle.id">
                      ...
                      <td>
                        {{
                          (detalle.precio * parseFloat(monedaVenta[0])).toFixed(
                            2
                          )
                        }}
                        {{ monedaVenta[1] }}
                        ...
                        <tbody>
                          <tr v-for="kit in arrayKit" :key="kit.id">
                            ...
                            <td>
                              {{
                                (
                                  kit.precio * parseFloat(monedaVenta[0])
                                ).toFixed(2)
                              }}
                              {{ monedaVenta[1] }}
                            </td>
                            <td>
                              {{
                                new Date(kit.fecha_final).toLocaleDateString(
                                  "es-ES"
                                )
                              }}
                            </td>
                            ...
                            <td>
                              ...
                              >&nbsp;
                              {{
                                new Date(kit.fecha_final) < new Date()
                                  ? "Inactivo"
                                  : kit.estado
                              }}
                            </td>
                  ...
                  <template>
                      ...
                      <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <input
                            ...
                            placeholder="Texto a buscar"
                            @keyup="
                              listarOfertaEspecial(1, buscarKit, criterioKit)
                            "
                          />
                        </div>
                      </div>
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <tbody>
                          <tr
                            v-for="kit in arrayPreciosEspeciales"
                            :key="kit.id"
                          >
                            <td>
            ...
            <b-tabs content-class="" fill>
              <b-tab>
                <template #title>
                  <span class="d-flex align-items-center">
                    <i
                      class="fa fa-money fa-2x icon-color mr-2"
                      aria-hidden="true"
                    ></i>
                          ...
                          <form>
                            <div class="form-group">
                              <label for="montoEfectivo"
                                ><i class="fa fa-money mr-2"></i> Monto
                                Recibido:</label
                              >
                              <div class="input-group mb-3">
                                <div class="input-group-prepend">
                      ...
                      <div class="card shadow-sm">
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between mb-2">
                            <span
                              ><i class="fa fa-dollar mr-2"></i> Monto
                              Total:</span
                            >
                          ...
                          <div class="d-flex justify-content-between mb-3">
                            <span
                              ><i class="fa fa-percent mr-2 text-danger"></i>
                              Impuestos:</span
                            >
                          ...
                          <div class="form-group">
                            <label for="codigoDescuento"
                              ><i class="fa fa-gift mr-2"></i> Código de
                              Descuento Gift Card:</label
                            >
                            <div class="input-group mb-3">
                              <input
                                type="number"
                                class="form-control"
                                id="descuentoGiftCard"
                                v-model="descuentoGiftCard"
                                min="0"
                              />
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="numeroTarjeta"
                              ><i class="fa fa-credit-card mr-2"></i> Número de
                              Tarjeta:</label
                            >
                            <div class="input-group mb-3">
                              <input
                          ...
                          <div class="d-flex justify-content-between">
                            <span
                              ><i class="fa fa-money mr-2"></i> Total a
                              Pagar:</span
                            >
              ...
              <b-tab>
                <template #title>
                  <span class="d-flex align-items-center">
                    <i
                      class="fa fa-gift fa-2x icon-color mr-2"
                      aria-hidden="true"
                    ></i>
                ...
                <div>
                  <div class="mt-4">
                    <form>
                      <div class="form-group">
                        <label for="descuentoGiftCard"
                          ><i class="fa fa-tag mr-2"></i> Monto de la Gift
                          Card:</label
                        >
                        <div class="input-group mb-3">
                          <input
              ...
              <b-tab>
                <template #title>
                  <span class="d-flex align-items-center">
                    <i
                      class="fa fa-credit-card fa-2x icon-color mr-2"
                      aria-hidden="true"
                    ></i>
                    <label>Tarjeta</label>
                  </span>
                ...
                <div>
                  <div class="mt-4">
                    <form>
                      ...
                      <div class="form-group">
                        <label for="codigoDescuento"
                          ><i class="fa fa-gift mr-2"></i> Código de Descuento
                          Gift Card:</label
                        >
                        <div class="input-group mb-3">
                          <input
              ...
              <b-tab>
                <template #title>
                  <span class="d-flex align-items-center">
                    <i
                      class="fa fa-university fa-2x icon-color mr-2"
                      aria-hidden="true"
                    ></i>
                  ...
                  <div class="d-flex justify-content-between mt-2">
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label" for="inlineRadio1">
                        <img
                          src="./../../../../public/img/bancos/logo_banco_union.jpg"
                          width="80px"
                          alt="Imagen 1"
                        />
                      </label>
                    ...
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label" for="inlineRadio2">
                        <img
                          src="./../../../../public/img/bancos/logo_mercantil_santacruz.jpg"
                          width="80px"
                          alt="Imagen 2"
                        />
                      </label>
                    ...
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label" for="inlineRadio3">
                        <img
                          src="./../../../../public/img/bancos/logo_bnb.png"
                          width="80px"
                          alt="Imagen 3"
                        />
                      </label>
                    ...
                    <div class="form-check form-check-inline">
                      ...
                      <label class="form-check-label" for="inlineRadio4">
                        <img
                          src="./../../../../public/img/bancos/logo_banco_bisa.png"
                          width="80px"
                          alt="Imagen 4"
                        />
                      </label>
                    ...
                    <form>
                      ...
                      <div class="form-group">
                        <label for="montoTransferencia"
                          ><i class="fa fa-money mr-2"></i> Monto de
                          Transferencia:</label
                        >
                        <div class="input-group mb-3">
                          <input
                      ...
                      <div class="form-group">
                        <label for="fechaTransferencia"
                          ><i class="fa fa-calendar mr-2"></i> Fecha de
                          Transferencia:</label
                        >
                        <div class="input-group mb-3">
                          <input
                      ...
                      <div class="form-group">
                        <label for="numeroOperacion"
                          ><i class="fa fa-hashtag mr-2"></i> Número de
                          Operación:</label
                        >
                        <div class="input-group mb-3">
                          <input
                      ...
                      <button
                        ...
                        class="btn btn-success btn-block"
                      >
                        <i class="fa fa-check mr-2"></i> Confirmar Transferencia
                      </button>
                    </form>
                  </div>
                </div>
              ...
              <b-tab>
                <template #title>
                  <span class="d-flex align-items-center">
                    <i
                      class="fa fa-list-alt fa-2x icon-color mr-2"
                      aria-hidden="true"
                    ></i>
                    <label>Otros</label>
                  </span>
                ...
                <div>
                  <div class="mt-4">
                    <form>
                      <div class="form-group">
                        <label for="otroMetodoPago"
                          ><i class="fa fa-tag mr-2"></i> Seleccione un Método
                          de Pago:</label
                        >
                        <div class="input-group mb-3">
                          <select
                          ...
                          >
                            ...
                            <option value="81"
                              >BILLETERA MOVIL – PAGO ONLINE</option
                            >
                            <option value="31">CANAL DE PAGO</option>
                            <option value="79"
                              >CANAL DE PAGO – BILLETERA MOVIL</option
                            >
                            <option value="80"
                              >CANAL DE PAGO – PAGO ONLINE</option
                            >
                            <option value="294"
                              >CANAL DE PAGO – BILLETERA MOVIL – PAGO
                              ONLINE</option
                            >
                            <option value="3">CHEQUE</option>
                            <option value="51">CHEQUE – BILLETERA</option>
                            <option value="213"
                              >CHEQUE – BILLETERA MOVIL – PAGO ONLINE</option
                            >
                            <option value="50">CHEQUE – CANAL PAGO</option>
                            <option value="211"
                              >CHEQUE – CANAL PAGO - BILLETERA MOVIL</option
                            >
                            <option value="212"
                              >CHEQUE – CANAL PAGO - PAGO ONLINE</option
                            >
                            <option value="47">CHEQUE – DEPOSITO</option>
                            <option value="202"
                              >CHEQUE – DEPOSITO EN CUENTA - BILLETERA
                              MOVIL</option
                            >
                            <option value="201"
                              >CHEQUE – DEPOSITO EN CUENTA - CANAL DE
                              PAGO</option
                            >
                            <option value="203"
                              >CHEQUE – DEPOSITO EN CUENTA - PAGO ONLINE</option
                            >
                            <option value="199"
                              >CHEQUE – DEPOSITO EN CUENTA - TRANSFERENCIA
                              SWIFT</option
                            >
                            <option value="38">EFECTIVO – PAGO ONLINE</option>
                            <option value="39">TARJETA – PAGO POSTERIOR</option>
                            <option value="191"
                              >CHEQUE – PAGO POSTERIOR - BILLETERA MOVIL</option
                            >
                            <option value="190"
                              >CHEQUE – PAGO POSTERIOR - CANAL DE PAGO</option
                            >
                            <option value="187"
                              >CHEQUE – PAGO POSTERIOR - DEPOSITO EN
                              CUENTA</option
                            >
                            <option value="192"
                              >CHEQUE – PAGO POSTERIOR - PAGO ONLINE</option
                            >
                            <option value="186"
                              >CHEQUE – PAGO POSTERIOR - TRANSFERENCIA
                              BANCARIA</option
                            >
                            <option value="188"
                              >CHEQUE – PAGO POSTERIOR - TRANSFERENCIA
                            ...
                            <option value="206"
                              >CHEQUE – SWIFT - BILLETERA MOVIL</option
                            >
                            <option value="207"
                              >CHEQUE – SWIFT - PAGO ONLINE</option
                            >
                            <option value="208"
                              >CHEQUE – GIFT - CANAL DE PAGO</option
                            >
                            <option value="46"
                              >CHEQUE – TRANSFERENCIA BANCARIA</option
                            >
                            <option value="197"
                              >CHEQUE – TRANSFERENCIA BANCARIA – BILLETERA
                              MOVIL</option
                            >
                            <option value="196"
                              >CHEQUE – TRANSFERENCIA BANCARIA – CANAL DE
                              PAGO</option
                            >
                            <option value="193"
                              >CHEQUE – TRANSFERENCIA BANCARIA – DEPOSITO EN
                              CUENTA</option
                            >
                            <option value="198"
                              >CHEQUE – TRANSFERENCIA BANCARIA – PAGO
                              ONLINE</option
                            >
                            <option value="194"
                              >CHEQUE – TRANSFERENCIA BANCARIA – TRANSFERENCIA
                              SWIFT</option
                            >
                            <option value="44">CHEQUE – VALES</option>
                            <option value="178"
                              >CHEQUE – VALES - PAGO POSTERIOR</option
                            >
                            <option value="179"
                              >CHEQUE – VALES - TRANSFERENCIA BANCARIA</option
                            >
                            <option value="180"
                              >CHEQUE – VALES - DEPOSITO EN CUENTA</option
                            >
                            <option value="181"
                              >CHEQUE – VALES - TRANSFERENCIA SWIFT</option
                            >
                            <option value="183"
                              >CHEQUE – VALES - CANAL DE PAGO</option
                            >
                            <option value="184"
                              >CHEQUE – VALES - BILLETERA MOVIL</option
                            >
                            <option value="185"
                              >CHEQUE – VALES - PAGO ONLINE</option
                            >
                            <option value="295">DEBITO AUTOMATICO</option>
                            <option value="296"
                              >DEBITO AUTOMATICO – EFECTIVO</option
                            >
                            <option value="297"
                              >DEBITO AUTOMATICO -TARJETA</option
                            >
                            <option value="298"
                              >DEBITO AUTOMATICO – CHEQUE</option
                            >
                            <option value="299"
                              >DEBITO AUTOMATICO - VALE</option
                            >
                            <option value="300"
                              >DEBITO AUTOMATICO - PAGO POSTERIOR</option
                            >
                            <option value="301"
                            ...
                            >
                            <option value="302"
                              >DEBITO AUTOMATICO - DEPOSITO EN CUENTA</option
                            >
                            <option value="303"
                              >DEBITO AUTOMATICO - TRANSFERENCIA SWIFT</option
                            >
                            <option value="304"
                              >DEBITO AUTOMATICO - GIFT CARD</option
                            >
                            <option value="305"
                              >DEBITO AUTOMATICO - CANAL DE PAGO</option
                            >
                            <option value="306"
                              >DEBITO AUTOMATICO - BILLETERA MOVIL</option
                            >
                            <option value="307"
                              >DEBITO AUTOMATICO - PAGO ONLINE</option
                            >
                            <option value="308"
                              >DEBITO AUTOMATICO – OTRO</option
                            >
                            <option value="8">DEPOSITO EN CUENTA</option>
                            <option value="71"
                              >DEPOSITO EN CUENTA – PAGO ONLINE</option
                            >
                            <option value="276"
                              >DEPOSITO EN CUENTA – SWIFT – CANAL DE
                              PAGO</option
                            >
                            <option value="277"
                              >DEPOSITO EN CUENTA – SWIFT – BILLETERA
                              MOVIL</option
                            >
                            <option value="278"
                              >DEPOSITO EN CUENTA – SWIFT – PAGO ONLINE</option
                            >
                            <option value="282"
                              >DEPOSITO EN CUENTA – CANAL DE PAGO – BILLETERA
                              MOVIL</option
                            >
                            <option value="70"
                              >DEPOSITO EN CUENTA – BILLETERA MOVIL</option
                            >
                            <option value="284"
                              >DEPOSITO EN CUENTA – BILLETERA MOVIL – PAGO
                              ONLINE</option
                            >
                            <option value="69"
                              >DEPOSITO EN CUENTA – CANAL DE PAGO</option
                            >
                            <option value="283"
                              >DEPOSITO EN CUENTA – CANAL DE PAGO – PAGO
                              ONLINE</option
                            >
                            ...
                            <option value="62"
                              >PAGO POSTERIOR – BILLETERA</option
                            >
                            <option value="259"
                              >PAGO POSTERIOR – BILLETERA MOVIL - PAGO
                              ONLINE</option
                            >
                            <option value="61">PAGO POSTERIOR – CANAL</option>
                            <option value="257"
                              >PAGO POSTERIOR – CANAL DE PAGO - BILLETERA
                              MOVIL</option
                            >
                            <option value="258"
                              >PAGO POSTERIOR – CANAL DE PAGO - PAGO
                              ONLINE</option
                            >
                            <option value="58"
                              >PAGO POSTERIOR – DEPOSITO EN CUENTA</option
                            >
                            <option value="245"
                              >PAGO POSTERIOR – DEPOSITO EN CUENTA –
                              TRANSFERENCIA SWIFT</option
                            >
                            <option value="247"
                              >PAGO POSTERIOR – DEPOSITO EN CUENTA – CANAL DE
                              PAGO</option
                            >
                            <option value="248"
                              >PAGO POSTERIOR – DEPOSITO EN CUENTA – BILLETERA
                              MOVIL</option
                            >
                            <option value="249"
                              >PAGO POSTERIOR – DEPOSITO EN CUENTA – PAGO
                              ONLINE</option
                            >
                            <option value="63"
                              >PAGO POSTERIOR – PAGO ONLINE</option
                            >
                            <option value="59">PAGO POSTERIOR – SWIFT</option>
                            <option value="251"
                              >PAGO POSTERIOR – SWIFT - CANAL DE PAGO</option
                            >
                            <option value="252"
                              >PAGO POSTERIOR – SWIFT - BILLETERA MOVIL</option
                            >
                            <option value="253"
                              >PAGO POSTERIOR – SWIFT - PAGO ONLINE</option
                            >
                            <option value="57"
                              >PAGO POSTERIOR – TRANSFERENCIA BANCARIA</option
                            >
                            <option value="239"
                              >PAGO POSTERIOR – TRANSFERENCIA BANCARIA –
                              DEPOSITO EN CUENTA</option
                            >
                            <option value="240"
                              >PAGO POSTERIOR – TRANSFERENCIA BANCARIA –
                              TRANSFERENCIA SWIFT</option
                            >
                            <option value="242"
                              >PAGO POSTERIOR – TRANSFERENCIA BANCARIA – CANAL
                              DE PAGO</option
                            >
                            <option value="243"
                              >PAGO POSTERIOR – TRANSFERENCIA BANCARIA –
                            ...
                            >
                            <option value="244"
                              >PAGO POSTERIOR – TRANSFERENCIA BANCARIA – PAGO
                              ONLINE</option
                            >
                            <option value="74">SWIFT – BILLETERA MOVIL</option>
                            <option value="290"
                              >SWIFT – BILLETERA MOVIL – PAGO ONLINE</option
                            >
                            <option value="291"
                              >GIFT-CARD – CANAL DE PAGO – BILLETERA
                              MOVIL</option
                            >
                            <option value="292"
                              >GIFT-CARD – CANAL DE PAGO – PAGO ONLINE</option
                            >
                            ...
                            <option value="66"
                              >TRANSFERENCIA BANCARIA – BILLETERA MOVIL</option
                            >
                            <option value="274"
                              >TRANSFERENCIA BANCARIA – BILLETERA MOVIL – PAGO
                              ONLINE</option
                            >
                            <option value="65"
                              >TRANSFERENCIA BANCARIA – CANAL DE PAGO</option
                            >
                            <option value="272"
                              >TRANSFERENCIA BANCARIA – CANAL DE PAGO –
                              BILLETERA MOVIL</option
                            >
                            <option value="273"
                              >TRANSFERENCIA BANCARIA – CANAL DE PAGO – PAGO
                              ONLINE</option
                            >
                            <option value="260"
                              >TRANSFERENCIA BANCARIA – DEPOSITO EN CUENTA –
                              TRANSFERENCIA SWIFT</option
                            >
                            <option value="262"
                              >TRANSFERENCIA BANCARIA – DEPOSITO EN CUENTA –
                              CANAL DE PAGO</option
                            >
                            <option value="263"
                              >TRANSFERENCIA BANCARIA – DEPOSITO EN CUENTA –
                              BILLETERA MOVIL</option
                            >
                            <option value="67"
                              >TRANSFERENCIA BANCARIA – PAGO ONLINE</option
                            >
                            <option value="266"
                              >TRANSFERENCIA BANCARIA – SWIFT – CANAL DE
                              PAGO</option
                            >
                            <option value="267"
                              >TRANSFERENCIA BANCARIA – SWIFT – BILLETERA
                              MOVIL</option
                            >
                            <option value="268"
                              >TRANSFERENCIA BANCARIA – SWIFT – PAGO
                              ONLINE</option
                            >
                            <option value="24"
                              >TRANSFERENCIA BANCARIA-DEPOSITO EN CUENTA</option
                            >
                            <option value="25"
                            ...
                            >
                            <option value="264"
                              >TRANSFERENCIA BANCARIA– DEPOSITO EN CUENTA – PAGO
                              ONLINE</option
                            >
                            ...
                            <option value="233"
                              >VALES – BILLETERA MOVIL – CANAL DE PAGO</option
                            >
                            <option value="234"
                              >VALES – BILLETERA MOVIL – BILLETERA MOVIL</option
                            >
                            <option value="235"
                              >VALES – BILLETERA MOVIL – PAGO ONLINE</option
                            >
                            <option value="54">VALES – CANAL DE PAGO</option>
                            <option value="227"
                              >VALES – CANAL DE PAGO – TRANSFERENCIA
                              SWIFT</option
                            >
                            <option value="229"
                              >VALES – CANAL DE PAGO – CANAL DE PAGO</option
                            >
                            <option value="230"
                              >VALES – CANAL DE PAGO – BILLETERA MOVIL</option
                            >
                            <option value="231"
                              >VALES – CANAL DE PAGO – PAGO ONLINE</option
                            >
                            <option value="22"
                              >VALES – DEPOSITO EN CUENTA</option
                            >
                            <option value="56">VALES – PAGO ONLINE</option>
                            <option value="236"
                              >VALES – PAGO ONLINE - CANAL DE PAGO</option
                            >
                            <option value="237"
                              >VALES – PAGO ONLINE - BILLETERA MOVIL</option
                            >
                            <option value="238"
                              >VALES – PAGO ONLINE - PAGO ONLINE</option
                            >
                            <option value="214"
                              >VALES – SWIFT - TRANSFERENCIA BANCARIA</option
                            >
                            <option value="215"
                              >VALES – SWIFT - DEPOSITO EN CUENTA</option
                            >
                            <option value="216"
                              >VALES – SWIFT - TRANSFERENCIA SWIFT</option
                            >
                            <option value="218"
                              >VALES – SWIFT - CANAL DE PAGO</option
                            >
                            <option value="219"
                              >VALES – SWIFT - BILLETERA MOVIL</option
                            >
                            <option value="220"
                              >VALES – SWIFT - PAGO ONLINE</option
                            >
                            <option value="21"
                              >VALES-TRANSFERENCIA BANCARIA</option
                            >
                            <option value="23"
                              >VALES-TRANSFERENCIA SWIFT</option
                            >
                          </select>
                        </div>
                      </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-3" v-if="primera_cuota">
                <div class="form-group">
                  <label class="form-control-label" for="select-input"
                    >Tipo de Pago</label
                  >
                  <select
                    class="form-control"
                  ...
                  >
                    <option v-for="(value, key) in tiposPago" :value="value">{{
                      key
                    }}</option>
                  </select>
                </div>
                  ...
                  <tbody>
                    <tr v-for="(cuota, index) in cuotas" :key="index">
                      ...
                      <td>
                        {{
                          (
                            cuota.precio_cuota * parseFloat(monedaVenta[0])
                          ).toFixed(2)
                        }}
                        {{ monedaVenta[1] }}
                      </td>
                      <td>
                        {{
                          (
                            cuota.totalCancelado * parseFloat(monedaVenta[0])
                          ).toFixed(2)
                        }}
                        {{ monedaVenta[1] }}
                      </td>
                      <td>
                        {{
                          (
                            cuota.saldo_restante * parseFloat(monedaVenta[0])
                          ).toFixed(2)
                        }}
                        {{ monedaVenta[1] }}
                      </td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="col-md-5">
              ...
              {{
                (
                  datosFormularioKit.precio * parseFloat(monedaVenta[0])
                ).toFixed(2)
              }}
              {{ monedaVenta[1] }}
            </div>
                ...
                <tbody>
                  <tr v-for="articulo in arrayArticulosKit" :key="articulo.id">
                    ...
                    <td>
                      <p>
                        {{
                          articulo.precio_costo_paq * parseFloat(monedaVenta[0])
                        }}
                        {{ monedaVenta[1] }}
                      </p>
                    </td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
              <div class="col-md-4">
                <div>
                  <label for="" class="font-weight-bold">Rango Inicio 1: </label
                  >{{ datosFormularioPE.rango_inicio_r1 }}
                </div>
              </div>
              <div class="col-md-4">
                <div>
                  <label for="" class="font-weight-bold">Rango Final 1: </label
                  >{{ datosFormularioPE.rango_final_r1 }}
                </div>
              </div>
              <div class="col-md-3">
                <div>
                  <label for="" class="font-weight-bold">Precio Rango 1: </label
                  >{{ datosFormularioPE.precio_r1 }}
                  <span
                    v-if="
                      totalCantidades >= datosFormularioPE.rango_inicio_r1 &&
                        totalCantidades <= datosFormularioPE.rango_final_r1
                    "
                  >
                    <i class="fas fa-check-circle text-success"></i>
                    <!-- Cambia esto por el icono de tu elección -->
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              <div class="col-md-4">
                <div>
                  <label for="" class="font-weight-bold">Rango Inicio 2: </label
                  >{{ datosFormularioPE.rango_inicio_r2 }}
                </div>
              </div>
              <div class="col-md-4">
                <div>
                  <label for="" class="font-weight-bold">Rango Final 2: </label
                  >{{ datosFormularioPE.rango_final_r2 }}
                </div>
              </div>
              <div class="col-md-3">
                <div>
                  <label for="" class="font-weight-bold">Precio Rango 2: </label
                  >{{ datosFormularioPE.precio_r2 }}
                  <span
                    v-if="
                      totalCantidades >= datosFormularioPE.rango_inicio_r2 &&
                        totalCantidades <= datosFormularioPE.rango_final_r2
                    "
                  >
                    <i class="fas fa-check-circle text-success"></i>
                    <!-- Cambia esto por el icono de tu elección -->
            ...
            <div class="form-group row">
              <div class="col-md-4">
                <div>
                  <label for="" class="font-weight-bold">Rango Inicio 3: </label
                  >{{ datosFormularioPE.rango_inicio_r3 }}
                </div>
              </div>
              <div class="col-md-4">
                <div>
                  <label for="" class="font-weight-bold">Rango Final 3: </label
                  >{{ datosFormularioPE.rango_final_r3 }}
                </div>
              </div>
              <div class="col-md-3">
                <div>
                  <label for="" class="font-weight-bold">Precio Rango 3: </label
                  >{{ datosFormularioPE.precio_r3 }}
                  <span
                    v-if="
                      totalCantidades >= datosFormularioPE.rango_inicio_r3 &&
                        totalCantidades <= datosFormularioPE.rango_final_r3
                    "
                  >
                    <i class="fas fa-check-circle text-success"></i>
                    <!-- Cambia esto por el icono de tu elección -->
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                  <tr
                    v-for="(articulo, index) in arrayArticulosKit"
                    :key="articulo.id"
                  >
                    <td v-text="articulo.codigo"></td>
                    <td v-text="articulo.nombre"></td>
          ...
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-danger"
              @click="agregarPE(datosFormularioPE)"
            >
              Agregar
            </button>
    ...
    <div>
      <AbonarCuota
        ...
        :modal="modalCuotas"
        :moneda="monedaVenta"
        :ventaCredito="arraySeleccionado"
        :arrayCuotas="arrayCuotas"
        @cerrar-modal="cerrarModalCuotas"
      />
    </div>
  </main>
...
>>>>>>> d0b3de9 (Mensaje de confirmación)
  ...
  methods: {
    ...
    abrirModalCuotas(idventa) {
      this.modalCuotas = 1;
      axios
        .get(`/credito/cuotas/venta/${idventa}`)
        .then((response) => {
          this.arrayCuotas = response.data.cuotasCredito;
          this.arraySeleccionado = response.data.creditoVenta;
          const cuotasPendientes = this.arrayCuotas.filter(
            (cuota) => cuota.estado === "Pendiente"
          );
          this.cuotaSeleccionada = cuotasPendientes.find(
            (cuota) => cuota.estado === "Pendiente"
          );
        })
        .catch((error) => {
...
>>>>>>> d0b3de9 (Mensaje de confirmación)
    ...
    verificarComunicacion() {
      axios
        .post("/venta/verificarComunicacion")
        .then(function(response) {
      ...
      axios
        ...
        .then(function(response) {
          if (response.data.transaccion != false) {
            ...
            document.getElementById("cufdValor").innerHTML =
              response.data.codigo;
            document.getElementById("cufd").className = "badge bg-info";
          } else {
            document.getElementById("cufd").innerHTML =
              "No existe CUFD vigente";
...
=======
        ...
        this.arrayDetalle.push({
          ...
          precio: precioArticulo,
          descuento:
            this.arrayPromocion && this.arrayPromocion.porcentaje !== undefined
              ? this.arrayPromocion.porcentaje
              : 0,
          stock: this.arraySeleccionado.saldo_stock,
          precioseleccionado: this.precioseleccionado,
        });
        ...
        this.arrayProductos.push({
          ...
          precioUnitario: parseFloat(this.precioseleccionado).toFixed(2),
          montoDescuento:
            this.arrayPromocion && this.arrayPromocion.porcentaje
              ? (
                  (this.arrayPromocion.porcentaje /
                    this.resultadoMultiplicacion) *
                  100
...
=======
    ...
    verificarFactura(cuf, numeroFactura) {
      var url =
        "https://pilotosiat.impuestos.gob.bo/consulta/QR?nit=5153610012&cuf=" +
        cuf +
        "&numero=" +
        numeroFactura +
        "&t=2";
    ...
    anularFactura(id, cuf) {
      swal({
        ...
        if (result.value) {
          let me = this;
          axios
            .get("/factura/obtenerDatosMotivoAnulacion")
            .then(function(response) {
              var respuesta = response.data;
...
=======
                  ...
                  const motivoSeleccionado = result.value;
                  axios
                    .get("/factura/anular/" + cuf + "/" + motivoSeleccionado)
                    .then(function(response) {
                      const data = response.data;
                      if (data === "ANULACION CONFIRMADA") {
                        swal("FACTURA ANULADA", data, "success");
                      } else {
                        swal("ANULACION RECHAZADA", data, "warning");
                      }
                    })
                    .catch(function(error) {
                      console.log(error);
      ...
      swal({
        ...
        .then((result) => {
          if (result.value) {
            console.log("El boton CARTA fue presionado");
            axios
              .get("/factura/imprimirCarta/" + id + "/" + email, {
                responseType: "blob",
              })
              .then(function(response) {
                window.location.href = "docs/facturaCarta.pdf";
...
>>>>>>> d0b3de9 (Mensaje de confirmación)
            ...
            console.log("El boton ROLLO fue presionado");
            axios
              .get("/factura/imprimirRollo/" + id + "/" + email, {
                responseType: "blob",
              })
              .then(function(response) {
                window.location.href = "docs/facturaRollo.pdf";
      ...
      axios
        .post("/venta/registrar", {
          ...
          totalCredito: this.primera_cuota
            ...
            : this.calcularTotal, // Asegúrate de tener esta variable
          estadoCredito: "Pendiente", // Asegúrate de tener esta variable
...
>>>>>>> d0b3de9 (Mensaje de confirmación)
    ...
    async emitirFactura(idVentaRecienRegistrada) {
      ...
      let descuentoAdicional = document.getElementById("descuentoAdicional")
        .value;
      let usuario = document.getElementById("usuarioAutenticado").value;
      //let codigoPuntoVenta = this.puntoVentaAutenticado;
      let codigoPuntoVenta = 0;
      ...
      axios
        ...
        .then(function(response) {
          ...
          if (data === "VALIDADA") {
            ...
            me.listarVenta(1, "", "id");
            me.mostrarSpinner = false;
            swal("FACTURA VALIDADA", "éxito", "success");
          }
        })
        .catch(function(error) {
          me.arrayProductos = [];
          me.codigoExcepcion = 0;
          swal("INTENTE DE NUEVO", "Comunicacion con SIAT fallida", "error");
          me.mostrarSpinner = false;
          me.idtipo_pago = "";
          me.numeroTarjeta = null;
          me.descuentoGiftCard = "";
    ...
    generarCuotas() {
      ...
      if (this.primera_cuota) {
        ...
        saldos_total = (this.calcularTotal - this.primer_precio_cuota).toFixed(
          2
        );
      ...
      for (let i = 0; i < this.numero_cuotas; i++) {
        const fechaPago = new Date(
          fechaInicioPago.getTime() + i * this.tiempo_diaz * 24 * 60 * 60 * 1000
        );
        ...
        const cuota = {
          ...
          fecha_cancelado:
            i === 0 && this.primera_cuota
              ? `${año}-${mes}-${dia} ${fechaPago.toLocaleTimeString()}`
              : null,
          estado:
            i === 0
              ? this.primera_cuota
