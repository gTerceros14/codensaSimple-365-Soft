                                ...
                                <td>
                                    <template v-if=caja.estado>
                                        <template v-if="!mostrarBotonesSecundarios">
                                            <button type="button" @click="abrirModal2('cajaDepositar', 'depositar', caja)"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" v-model="saldoInicial" class="form-control"
                                        placeholder="Ingresar saldo inicial" pattern="^(0|0\.5|9999)$">
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion == 1" class="btn btn-primary"
                            @click="registrarCaja()">Guardar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" v-model="depositos" class="form-control" placeholder="0.00">
                                </div>

                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Descripción de Importe</label>
                                <div class="col-md-9">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion == 2" class="btn btn-primary" @click="depositar()">Depositar
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Importe</label>
                                <div class="col-md-9">
                                    <input type="number" v-model="salidas" class="form-control" placeholder="0.00">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Descripcion de Salida</label>
                                <div class="col-md-9">
                                    <input type="text" v-model="Dessalidas" class="form-control" placeholder="Descripción">
                                </div>
                            </div>
                            <div v-show="errorCaja" class="form-group row div-error">
                                <div class="text-center text-error">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="billete200" class="form-control form-control-sm"
                                                placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="billete100" class="form-control form-control-sm"
                                                placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="billete50" class="form-control form-control-sm"
                                                placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="billete20" class="form-control form-control-sm"
                                                placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="billete10" class="form-control form-control-sm"
                                                placeholder="0">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="moneda5" class="form-control form-control-sm"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="moneda2" class="form-control form-control-sm"
                                                id="" name="" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="moneda1" class="form-control form-control-sm"
                                                id="" name="" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="moneda050" class="form-control form-control-sm"
                                                id="" name="" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="moneda020" class="form-control form-control-sm"
                                                id="" name="" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" v-model="moneda010" class="form-control form-control-sm"
                                                id="" name="" placeholder="0">
                                        </div>
                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" v-if="tipoAccion == 5" class="btn btn-primary"
                            @click="registrarArqueo()">Guardar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
                            ...
                            case 'ver':
                                {
                                    ...
                                    axios.get(url).then(function (response) {
                                        ...
                                        // me.pagination = respuesta.pagination;
                                        me.ArrayEgresos = respuesta.ingresos.data;
