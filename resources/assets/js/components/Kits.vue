          ...
          <div class="form-group row">
            <div class="col-md-6">
              <div class="input-group">
                ...
                <input type="text" v-model="buscar" @keyup.enter="listarKits(1, buscar, criterio)" class="form-control"
          ...
          <form @submit.prevent="enviarFormulario">
            <div class="modal-body">
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <label for="" class="font-weight-bold">Codigo <span class="text-danger">*</span></label>
                  <input type="text" v-model="datosFormulario.codigo" class="form-control" placeholder="Ej. XXXXX"
                    :class="{ 'is-invalid': errores.codigo }" @input="validarCampo('codigo')" />
                  <p class="text-danger" v-if="errores.codigo">{{ errores.codigo }}</p>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-6">
                  <label for="" class="font-weight-bold">Precio <span class="text-danger">*</span></label>
                  <input type="number" v-model="datosFormulario.precio" class="form-control"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="col-md-5">
              ...
              {{ (datosFormulario.precio * parseFloat(monedaPrincipal[0])).toFixed(2) }} {{
                monedaPrincipal[1]
              }}
            </div>
            <div class="col-md-5">
