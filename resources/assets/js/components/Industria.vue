                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <input type="text" v-model="buscar" @keyup.enter="listarIndustria(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                            <button type="submit" @click="listarIndustria(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                        <tr v-for="industria in arrayIndustria" :key="industria.id">
                            <td>
                                <button type="button" @click="abrirModal('industria','actualizar',industria)" class="btn btn-warning btn-sm">
        ...
        <div class="modal-dialog modal-primary modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="nombre" class="form-control" placeholder="Nombre de Industria"> 
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarIndustria()">Guardar</button>
                    <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarIndustria()">Actualizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
