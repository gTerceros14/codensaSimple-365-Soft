                        ...
                        <table class="table table-bordered table-striped table-sm" >
                            ...
                            <tbody>
                                <tr v-for="articulo in sortedResultados" :key="articulo.id">
                                    ...
                                    <td v-if="articulo.tipo === 'Ingreso'" v-text="articulo.precio_ingreso"></td>
                                    <td v-else>
                                        <span v-if="articulo.tipo === 'Venta'" v-text="articulo.precio_venta"></span>
                                    </td>
                                    <td v-if="articulo.tipo === 'Ingreso'" v-text="articulo.subtotal"></td>
                                    <td v-else></td>
                                    <td v-if="articulo.tipo === 'Venta'" v-text="articulo.subtotal"></td>
                                    <td v-else></td>
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="date" id="fechaInicio" v-model="fechaInicio" >
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" type="date" id="fechaFin" v-model="fechaFin">
