            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="number-input">Codigo</label>
                            <div class="col-md-9">
                                <input type="number" v-model="codigoProductoSin" class="form-control" placeholder="Ingrese el codigo" step="1">
                            </div>
                        </div>
